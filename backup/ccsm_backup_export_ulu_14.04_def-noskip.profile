...
[core]
s0_active_plugins = core;composite;opengl;mousepoll;wall;move;commands;place;vpswitch;grid;ring;copytex;compiztoolbox;resize;regex;imgpng;session;animation;unitymtgrabhandles;expo;fade;ezoom;scale;workarounds;unityshell;
...
s0_glide2_away_position = -0,000000
