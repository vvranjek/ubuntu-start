...
s0_sidekick_num_rotations = 0.000000
...
[core]
s0_active_plugins = core;composite;opengl;resize;place;vpswitch;snap;regex;ring;wall;imgpng;animation;compiztoolbox;move;commands;session;copytex;unitymtgrabhandles;fade;grid;mousepoll;workarounds;scale;expo;ezoom;unityshell;
